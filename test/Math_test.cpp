...
void Math_test::test_factorial()
{
  QCOMPARE(factorial(0), 1);
  QCOMPARE(factorial(1), 1);
  QCOMPARE(factorial(2), 2);
  QCOMPARE(factorial(3), 6);
  QCOMPARE(factorial(4), 24);
  QCOMPARE(factorial(5), 120);
  QCOMPARE(factorial(6), 720);
  QCOMPARE(factorial(7), 5040);
  QCOMPARE(factorial(8), 40320);
  QCOMPARE(factorial(9), 362880);
...
void Math_test::test_solveQuadratic()
{
  ...
  double x1 = 0, x2 = 0;
  QCOMPARE(solveQuadratic(1, -3, 4, x1, x2), 0);

  // Solve: -4x^2 + 12x - 9 = 0 (has ONE solution)
  x1 = 0; x2 = 0;
  QCOMPARE(solveQuadratic(-4, 12, -9, x1, x2), 1);
  QCOMPARE(x1, 1.5);
  QCOMPARE(x2, 1.5);

  // Solve: 2x^2 - 11x + 5 = 0 (has TWO solutions)
  x1 = 0; x2 = 0;
  QCOMPARE(solveQuadratic(2, -11, 5, x1, x2), 2);
  QCOMPARE(x1, 0.5);
  QCOMPARE(x2, 5);
}
...
void Math_test::test_solveCubic()
{
  ...
  QCOMPARE(solveCubic(1, -sqrt(3), -2, 2*sqrt(3), x1, x2, x3), 3);
  ...
  x1 = 0; x2 = 0; x3 = 0;
  QCOMPARE(solveCubic(1, -4, 5, -2, x1, x2, x3), 2);
  ...
  x1 = 0; x2 = 0; x3 = 0;
  QCOMPARE(solveCubic(1, 0, 1, -2, x1, x2, x3), 1);
  QVERIFY(qFuzzyCompare(x1, 1));
  ...
  x1 = 0; x2 = 0; x3 = 0;
  QCOMPARE(solveCubic(2, 10, -2, -4, x1, x2, x3), 3);
  ...
  x1 = 0; x2 = 0; x3 = 0;
  QCOMPARE(solveCubic(1, -0.4, 0.05, -0.002, x1, x2, x3), 2);
  QCOMPARE(x1, 0.1);
  QCOMPARE(x2, 0.2);
  ...
  x1 = 0; x2 = 0; x3 = 0;
  QCOMPARE(solveCubic(1, 0.7, 2.7, -0.9, x1, x2, x3), 1);
  QCOMPARE(x1, 0.3);
